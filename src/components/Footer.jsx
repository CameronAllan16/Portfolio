    ...
    <footer className="footer">
      ...
      <div className="footer-content-container">
        <div className="socials">
          ...
          <a href="https://www.linkedin.com/in/cameronallan2/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={28}
              height={28}
          ...
          <a href="https://www.shutterstock.com/g/Cameron+Allan/sets/325728046?rid=250349332">
            <svg
              ...
              <path
                fill="#000"
                fill-rule="evenodd"
                d="M0 24C0 10.7452 10.7452 0 24 0C37.2548 0 48 10.7452 48 24C48 37.2548 37.2548 48 24 48C10.7452 48 0 37.2548 0 24ZM22.2392 14.8298L22.2393 9.6H15.9713C12.4582 9.6 9.6 12.4582 9.6 15.9713V22.0007H14.8298V15.9713C14.8298 15.3417 15.3417 14.8298 15.9713 14.8298H22.2392ZM38.4 31.8484V25.819H33.1702V31.8484C33.1702 32.4779 32.6583 32.9899 32.0287 32.9899H25.7607V38.2197H32.0287C35.5418 38.2197 38.4 35.3614 38.4 31.8484Z"
                clip-rule="evenodd"></path>
            </svg>
          </a>
